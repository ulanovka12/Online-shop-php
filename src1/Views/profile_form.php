...
<aside class="profile-card">
    <header>
        <a target="_blank" href="/profile-change">
            <img src="<?php echo $user->getImage() ?>" class="hoverZoomLink" alt="Аватар">
        </a>
        <h1>
            <label for="name"><b><?php echo $user->getName(); ?></b></label>
        </h1>
        <h2>Цитата Джейсона Стэтхема</h2>
    </header>
    <div class="profile-bio">
        <p>Будь как кот, всегда ленивый, но когда охота, то весь фокус на жертве</p>
    </div>
...
<head>
    ...
    <style>
        ...
        .profile-card header a:after {
            ...
            transform: scale(0);
            background: -webkit-linear-gradient(top, #FFFFFF 0%, #FFFFFF 33.33%, #0039A6 33.33%, #0039A6 66.66%, #D52B1E 66.66%, #D52B1E 100%);
            background: linear-gradient(#FFFFFF 0%, #FFFFFF 33.33%, #0039A6 33.33%, #0039A6 66.66%, #D52B1E 66.66%, #D52B1E 100%);
            -webkit-border-radius: 50%;
            border-radius: 50%;
        ...
        @keyframes materia {
            ...
            100% { width: 440px; height: 280px; background: #FFFFFF; border-radius: 4px; }
        }
        ...
        @media screen and (min-aspect-ratio: 4/3) {
            ...
            @-webkit-keyframes puff {
                0% { top: 100%; width: 0px; padding-bottom: 0px; }
        ...
        @media screen and (min-height: 480px) {
            .profile-card header {
                width: auto; height: auto; padding: 30px 20px; display: block; float: none; border-right: none;
            }
            .profile-card .profile-bio {
                width: auto; height: auto; padding: 15px 20px 30px 20px; display: block; float: none;
            }
            .profile-social-links {
            ...
            @-webkit-keyframes materia {
                0% { background: #E0E0E0; }
                50% { -webkit-border-radius: 4px; }
                100% { width: 280px; height: 440px; background: #FFFFFF; -webkit-border-radius: 4px; }
            }
            @keyframes materia {
                0% { background: #E0E0E0; }
                50% { border-radius: 4px; }
                100% { width: 280px; height: 440px; background: #FFFFFF; border-radius: 4px; }
            }
        }
    </style>
</head>
